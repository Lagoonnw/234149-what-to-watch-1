...
export const FilmCard = ({movie, history}) => {
  const {name, genre, released, posterImage, backgroundColor, backgroundImage, director, starring, runTime} = movie;
  console.log('movie', movie, name, genre, released, posterImage );
  return (
    <Fragment>
